...
class Teacher(Base):
    ...
    # Crossing -> таблиця [teachers] має атрибут [students] якiй звертається до класу [Student] через додаткову
    # таблицю [teachers_to_students] та в класi [Student] ще лежить властивiсть teachers.
    # таке ж саме потрiбно зробити для класу [Student], але там Crossing на students...
